...
public class ComparingWrappers {
    ...
    public static void main(String[] args) {
        ...
        Double d5 = 8.0;
        int i2 = 8;
        System.out.println(d5.equals(i2)); // false  //with equals(), the primitive is boxed // with ==, the wrapper is unboxed
        System.out.println("-------------");

        Long iq=500L;
        Long iq1=500L;
        System.out.println("fff"+(iq == iq1)); 
...
//        System.out.println(b4 == s2);       // does not compile
        ...
        Double d6 = 1.12;
        Double d7 = 1.12;
        System.out.println(d6 == d7);           // always false because caching does not happen to Float and Double
