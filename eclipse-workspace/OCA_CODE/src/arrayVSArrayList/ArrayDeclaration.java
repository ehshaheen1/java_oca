...
//      int [] [] integerArray3 = new int[][] {7,7,7};      // does not compile, missing dimension
      ...
      System.out.println(integerArray4[1].length);
...
//      int [] [] integerArray7 = new int [][] {{1,1,1}  {2,2,2}};    // does not compile, missing comma
      ...
      int [][] integerArray11 = new int [2][];
      integerArray11 [0] = new int[]{3,3,3,3,3};       // does not compile, initialisation can be done only during declaration
