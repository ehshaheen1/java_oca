...
public class ArrayAndArraylistDifferences {
	...
	public static void main(String[] args) {
       ...
       //System.out.println(arrayOfStephenKingsNovelsMadeIntoMovies[0]);
       ...
       arraylistOfLedZeppelinSongs.add(3, "Dazed and Confused");
		...
		/*
		 * for (String string : arraylistOfLedZeppelinSongs) {
    ...
    // 4. array can hold both primitives and object types.
   //arrayList can hold only objects. Primitives added to the arrayList will be autoboxed with appropriate wrappers
       ...
       ArrayList<Integer> zeppelinAlbumsRelease = new ArrayList<>();
